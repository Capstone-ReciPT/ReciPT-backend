...
public class ProfileEmbed extends BaseTimeEntity {
    @Id
    @GeneratedValue
    ...
    public static ProfileEmbed createProfile(String filename, String type, byte[] profileData) {
        return new ProfileEmbed(filename, type, profileData);
    }
