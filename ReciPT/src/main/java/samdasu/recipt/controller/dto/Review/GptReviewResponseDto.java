...
public class GptReviewResponseDto {
    ...
    public GptReviewResponseDto(Long reviewId, String username, String title, String comment, Long viewCount, Integer likeCount, GptRecipe gptRecipe, List<ImageFileResponseDto> imageFiles) {
    ...
    public static GptReviewResponseDto createGptReviewResponseDto(Long reviewId, String username, String title, String comment, Long viewCount, Integer likeCount, GptRecipe gptRecipe, List<ImageFileResponseDto> imageFiles) {
