...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit1() {
            ...
            Review review1 = Review.createDbReview("새우두부계란찜 후기", "맛있는 계란찜", 0, 0, user, dbRecipe1);
            em.persist(review1);

            Review review2 = Review.createDbReview("부추 콩가루 찜 후기", "이게 무슨 요리지?", 0, 0, user, dbRecipe2);
            em.persist(review2);
        }
        ...
        public void dbInit2() {
            ...
            Review review1 = Review.createDbReview("사과 새우 북엇국 후기", "얼큰하다", 0, 0, user, dbRecipe1);
            em.persist(review1);

            Review review2 = Review.createDbReview("황태해장국 후기", "해장에 딱이지", 0, 0, user, dbRecipe2);
            em.persist(review2);
        }
        ...
        public void gptInit1() {
            ...
            GptRecipe gptRecipe1 = GptRecipe.createGptRecipe("계란찜", "계란, 파, 당근", "1.손질 2.굽기 3.먹기", "케찹 추가 맛있어요.", 0, 0, 0.0, 0, allergy);
            em.persist(gptRecipe1);

            GptRecipe gptRecipe2 = GptRecipe.createGptRecipe("계란후라이", "계란", "1.계란 톡 2.굽기", "케찹이랑 먹으면 맛있어요.", 0, 0, 0.0, 0, allergy);
            em.persist(gptRecipe2);

            Review review1 = Review.createGptReview("계란찜 후기", "밥도둑이네", 0, 0, user, gptRecipe1);
            em.persist(review1);

            Review review2 = Review.createGptReview("계란후라이 후기", "아침에는 계란 후라이", 0, 0, user, gptRecipe2);
            em.persist(review2);
        }
        ...
        public void gptInit2() {
            ...
            GptRecipe gptRecipe1 = GptRecipe.createGptRecipe("오므라이스", "계란, 밥, 당근, 양파", "1.채소 썰기 2.굽기 3.플레이팅", "김이랑 먹으면 맛있어요.", 0, 0, 0.0, 0, allergy);
            em.persist(gptRecipe1);

            GptRecipe gptRecipe2 = GptRecipe.createGptRecipe("오이무침", "오이, 쪽파, 양파, 고춧가루, 참기름, 깨", "1.채소 손질 2.버무리기 3.플레이팅", "밥이랑 먹으면 맛있어요.", 0, 0, 0.0, 0, allergy);
            em.persist(gptRecipe2);

            Review review1 = Review.createGptReview("오므라이스 후기", "어린아이도 좋아해요", 0, 0, user, gptRecipe1);
            em.persist(review1);

            Review review2 = Review.createGptReview("오이무침 후기", "아삭아삭 오이무침", 0, 0, user, gptRecipe2);
            em.persist(review2);
        }
        ...
        public void reviewInit() {
            ...
            for (int i = 0; i < 10; i++) {
                Review review1 = Review.createGptReview("계란찜 후기", "밥도둑이네", 0, 0, user, gptRecipe);
                em.persist(review1);
