    ...
    public List<ImageFile> parseFileInfo(List<MultipartFile> multipartFiles) throws Exception {
        ...
        if (!CollectionUtils.isEmpty(multipartFiles)) {
            ...
            for (MultipartFile multipartFile : multipartFiles) {
                ...
                // 파일 DTO 생성
                PhotoDto photoDto = PhotoDto.createPhotoDto(multipartFile.getOriginalFilename(), path + File.separator + new_file_name, multipartFile.getSize());


                // 파일 DTO 이용하여 Photo 엔티티 생성
                ImageFile imageFile = ImageFile.createFileHandler(photoDto.getOrigFileName(), photoDto.getFilePath(), photoDto.getFileSize());
