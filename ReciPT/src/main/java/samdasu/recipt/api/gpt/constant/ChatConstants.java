...
public class ChatConstants {
    ...
    public static final String SAVE_APPEND_MESSAGE = "[저장] '이라는 채팅을 받으면 JSON 형식으로만 응답하세요. 이전 대화 과정을 통해 만들어진 레시피를 이용해서 아래의 JSON 형식에 맞게 값을 작성해주고 JSON이 아닌 다른 단어나 문장을 포함해서 응답하지마세요." +
            "JSON의 값은 {\"foodName\":요리 이름, \"ingredient\":재료 , \"context\":조리 과정} 형태로 구성되어 있습니다. 요리 이름, 재료, 조리 과정을 이전 대화를 통해 만들어진 레시피로 값을 채우면 됩니다." +
            "ex) {\"foodName\":\"계란말이\", \"ingredient\":\"계란 2개, 소금 약간\",\"context\":\"1.계란을 프라이팬에 데운다. 2. 잘 익혀준다.\"}" +
            "이때 ingredient는 ,로 구분해주고 context는 1. 2. 와 같이 순서로 구분해서 응답해주세요." +
            "다시 한 번 강조하지만 '저장' 채팅을 수신할 때 위의 양식에 맞게 JSON 형식의 값으로만 응답하십시오. 다른 단어나 정보를 포함하지 마십시오.";
