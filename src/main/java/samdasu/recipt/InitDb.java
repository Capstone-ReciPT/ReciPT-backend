...
public class InitDb {
    ...
    static class InitService {
        ...
        public void recipeInit1() {
            ...
            User user = User.createUser("testerA", "testA", passwordEncoder.encode("A1234"), 10, null);
            em.persist(user);
        ...
        public void recipeInit2() {
            User user = User.createUser("testerB", "testB", passwordEncoder.encode("B1234"), 20, null);
            em.persist(user);
        ...
        public void registerRecipeInit1() {
            User user = User.createUser("testerC", "testC", passwordEncoder.encode("C1234"), 30, null);
            em.persist(user);
        ...
        public void registerRecipeInit2() {
            ...
            RegisterRecipe registerRecipe = RegisterRecipe.createRegisterRecipe(gpt.getFoodName(), "버섯을 먹어보아요", "고기랑 같이 먹어요", "채소", gpt.getIngredient(), gpt.getContext(),
        ...
        public void registerRecipeInit3() {
            ...
            RegisterRecipe registerRecipe = RegisterRecipe.createRegisterRecipe(gpt.getFoodName(),  "오이무침을 먹어보아요", "밥이랑 같이 먹어요", "채소", gpt.getIngredient(), gpt.getContext(),
                    500L, 35, 0.0, 0, null, null, user, gpt);
            em.persist(registerRecipe);
