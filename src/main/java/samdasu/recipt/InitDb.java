...
//
//            User user = User.createUser("initTesterA", "initTesterA", passwordEncoder.encode("initTesterA1234"), 10, "s_3fe3d7ec-4518-4e64-9df0-248cb6648274_1000007347", Collections.singletonList(Authority.ROLE_USER.name()));
//            em.persist(user);
//
//            Recipe recipe1 = Recipe.createRecipe("김치 부대찌개", "다시마 1g, 두부 10g, 떡국 떡 10g, 스팸(마일드) 10g, 다진 마늘 5g, 무 20g, 김치 15g, 소시지 10g(1/2개), 우민찌 5g(1작은술), 양파 5g, 저염된장 15g(1큰술), 베이컨 5g, 대파 5g, 청양고추 5g, 홍고추 1g", "찌개", "http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00138_1.png",
...
//            em.persist(recipe1);
//
//            Recipe recipe2 = Recipe.createRecipe("포도 주스", "포도 100g(1/2개)", "주스", "http://www.foodsafetykorea.go.kr/uploadimg/cook/10_00108_1.png",
//                    "1. 포도는 깨끗이 씻어 껍질을 벗긴다. 2. 포도, 물(50ml)을 믹서에 곱게 간다. 4. 믹서에 갈아낸 주스는 고운 체로 거른다. 5. 주스를 살얼음이 생길 만큼 시원하게 냉동한다. 6. 컵에 담아 마무리한다.", "http://www.foodsafetykorea.go.kr/uploadimg/cook/20_00108_1.jpg, http://www.foodsafetykorea.go.kr/uploadimg/cook/20_00108_2.jpg, http://www.foodsafetykorea.go.kr/uploadimg/cook/20_00108_3.jpg, http://www.foodsafetykorea.go.kr/uploadimg/cook/20_00108_4.jpg, http://www.foodsafetykorea.go.kr/uploadimg/cook/20_00108_5.jpg",
//                    50L, 50, 4.0, 1);
//            em.persist(recipe2);
//
...
//            em.persist(review1);
//
//            Review review2 = Review.createRecipeReview("포도 주스 후기", 4, 4.0, user, recipe2);
//            em.persist(review2);
//
...
//            User user = User.createUser("testerB", "testB", passwordEncoder.encode("B1234"), 20, null, Collections.singletonList(Authority.ROLE_USER.name()));
//            em.persist(user);
//
...
//            User user = User.createUser("testerC", "testC", passwordEncoder.encode("C1234"), 30, null, Collections.singletonList(Authority.ROLE_USER.name()));
//            em.persist(user);
//
...
//                    400L, 55, 0.0, 0, null, null, user, gpt);
...
//            em.persist(gpt);
//
//            RegisterRecipe registerRecipe = RegisterRecipe.createRegisterRecipe(gpt.getFoodName(), "고기랑 같이 먹어요", "채소", gpt.getIngredient(), gpt.getContext(),
//                    500L, 35, 0.0, 0, null, null, user, gpt);
//            em.persist(registerRecipe);
//
...
//            em.persist(gpt);
//
//            RegisterRecipe registerRecipe = RegisterRecipe.createRegisterRecipe(gpt.getFoodName(),  "밥이랑 같이 먹어요", "채소", gpt.getIngredient(), gpt.getContext(),
//                    500L, 35, 0.0, 0, null, null, user, gpt);
//            em.persist(registerRecipe);
//
