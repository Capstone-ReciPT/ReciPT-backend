...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        LoginForm loginRequestDto = null;
        try {
            loginRequestDto = om.readValue(request.getInputStream(), LoginForm.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        log.info("Authentication : " + principalDetailis.getUser().getLoginId());
